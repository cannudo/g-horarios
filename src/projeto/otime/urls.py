...
from .views import  index, salas, reservarHorario, professores, disciplinas, atualizar_professor, deletar_professor, criar_professor, atualizar_disciplina, deletar_disciplina, criar_disciplina, criar_sala
urlpatterns = [
