...
from .views import  index, salas, buscas, reservarHorario, exibeSlotTurma, exibeSlotDisciplina, exibeSlotSala, filtroTurma, filtroSala, filtroDisciplina, professores, turmas, disciplinas, seletor_turmas, atualizar_professor, atualizar_disciplina, atualizar_sala, atualizar_turma
urlpatterns = [
